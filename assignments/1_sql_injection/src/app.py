...
def prefill():
    ...
    astronauts = [
        ...
        ('Howard Wolowitz', 'Apollo 11', 'Payload Specialist', 'First NASA Engineer in space', 'https://yt3.googleusercontent.com/ytc/AIdro_nrUCA3ICcPgx6_8J_rdEFlh8MU4Q4HaoweIZRHiTzrLg=s900-c-k-c0x00ffffff-no-rj'),
        ...
        ('Simon Wilmots', 'CRS-23', 'Mission Specialist', 'First astronaut from Hasselt University', 'https://media.licdn.com/dms/image/v2/D4E03AQEvqJVZ042IpQ/profile-displayphoto-shrink_200_200/profile-displayphoto-shrink_200_200/0/1720721310891?e=2147483647&v=beta&t=JKMiVPwx0zuFO2F0QXngejAL3P1pOzm-2wtO4J-sfC8'),
...
def search():
    ...
    query = f"SELECT * FROM astronauts WHERE name LIKE '%{name}%'"
...
def home():
    ...
    cursor.execute('SELECT name, mission, rank, achievements, picture FROM astronauts')
    astronauts = cursor.fetchall()
